...
This master write-up documents the end-to-end solutions, reversing procedures, cryptographic attacks, forensic recoveries, and exploitation primitives for all 110 CTF challenges in the repository.

### CATEGORY DISTRIBUTION OVERVIEW
- **Reverse Engineering**: 20 Challenges
- **Cryptography**: 25 Challenges
- **Forensics**: 25 Challenges
- **AI / ML Security**: 0 Challenges
...
### 4. AI / ML SECURITY & PROMPT INJECTION (0 Challenges)
